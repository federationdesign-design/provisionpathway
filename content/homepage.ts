...
export const details = {
  ...
  location: {
    label: 'Location:',
    body: 'The assessment itself is delivered online, for families in the Warwickshire area.',
  },
  included: {
  ...
  format: {
    label: 'Format:',
    body: 'The debrief is delivered remotely via video call as standard.',
  },
};

// The services popup, opened from the Pathway nav item and the About the
// assessment button. Entered as supplied, then corrected on instruction so
// that every meeting and session is described as delivered online.
  ...
  services: [
    {
      ...
      facts: [
        ...
        {
          label: 'Location:',
          body: 'The assessment itself is delivered virtually (dependant on personal circumstances), for families in the Warwickshire area. The debrief afterwards is remote.',
        },
      ],
      list: {
        label: 'What\u2019s included',
        ordered: false,
        items: [
          'The assessment itself and the written report.',
